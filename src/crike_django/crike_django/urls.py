...
urlpatterns = patterns('',
    url(r'^$', TemplateView.as_view(template_name='registration/index.html'), name='home' ),
    url(r'^index', TemplateView.as_view(template_name='registration/index.html'), name='index' ),
